<template>
  ...
  />
  <Nav
    v-if="!this.showWebView"
    open_button_style="icon"
    open_button_color="white"
  />
  <div class="graphic" style="background-color: #111111">
    <img
      src="@/assets/images/newlogo.png"
      style="height: 70px; margin-top: 4vh; margin-left: 4vh"
    />
  </div>
  ...
  <section
    :class="[
      'content-wrapper',
      'full',
      this.screenWidth > 1000 ? 'web' : 'mobile',
    ]"
  >
    <div class="center">
    ...
    >
      <div class="content">
        ...
        <div class="text">
          ...
          called TEDx IITPatna, where x = independently organized TED event. At
          our TEDx IITPatna event, TED Talks video and live speakers will
    ...
    >
      <div class="content">
        ...
        <div class="text">
          Since 2016 TEDx IITPatna has strived to establish momentous and
          ...
          symbiosis and the independent yet collaborative spirit that allows us
          to reach new heights. Featuring diverse speakers from various walks of
          life, we hope to provide an enlightening experience to our community.
        </div>
      </div>
      <div class="graphic" id="c">
        <img src="@/assets/images/Group32068.png" />
      </div>
    </section>
  </section>
