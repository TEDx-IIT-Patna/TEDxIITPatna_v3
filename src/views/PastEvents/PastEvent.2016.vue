<template>
  ...
  <section class="intro-wrapper full">
    ...
    <div class="content">
      <div class="title">
        <p class="text">Shedding Off Feathers<sub class="sub">(2016)</sub></p>
      </div>
      <div class="intro">
        <div class="quote">
          <div class="text">
        ...
        TEDxIITPatna believes that building anything new is possible when we let
        go of the old. Just as birds shed their feathers, allowing the new ones
        to embrace, taking them afresh to infinite skies, bringing out change is
        an inevitable part of one's life to keep walking the course of life.<br /><br />
        <span>A change within us to become better.</span><br />
        <span
          >A change within the society to make this a better place to live
          in.</span
        >
      </div>
    </div>
  ...
  <section class="gallery-wrapper full">
    <div class="content">
      ...
      <div class="gallery">
        ...
        >
          <img
            :src="require(`@/assets/past-events/gallery-images/2016/${i}.jpg`)"
          />
        </div>
      </div>
    </div>
      ...
      speakerDetails: [
        {
          name: "Ashok Krish",
          title:
            "Head of Social Media & Workplace Reimagination Practice at TCS Digital Enterprise at Tata Consultancy Services",
          imageSrc: require("@/assets/past-events/speaker-images/2016/Ashok.png"),
          content:
            "A multi-faceted and dynamic leader, a lifelong technology geek, an open-source enthusiast and a talented musician, he is specialised in the 'Human cloud', which describes the architecture of social technologies and their interplay between people and technology.",
        ...
        },
        {
          ...
          content:
            "Currently heads the department of Glaucoma at Aravind Eye Hospital, Madurai; Dr George is the South Zone representative of the present executive committee of the Glaucoma Society Of India. His video, Evolution Of An Affordable Aqueous Drainage Implant – The Indian Story, was one of the three winning films at the World Glaucoma Congress 2013 held in Vancouver.",
        ...
        },
        {
          ...
          content:
            "Being the founder of the MERF Institute of Speech and Hearing, Dr Mohan Kameswaran has many firsts to his credit, such as the performance of the first auditory brain stem implantation surgery, the first pediatric brain stem implantation surgery etc. He was awarded the fourth highest civilian honour of the Padma Shri, in 2006, for his contributions to Indian medicine.",
          speakerTalkLink: "",
        },
        {
