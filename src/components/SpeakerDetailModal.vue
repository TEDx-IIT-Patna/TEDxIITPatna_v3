...
<template>
  <div
    :class="[
      ...
      0.9 * this.screenWidth >= this.screenHeight ? 'web' : 'mobile',
    ]"
    v-if="this.showModal"
  >
    <div class="overlay"></div>
    <div class="container">
      <div class="close-btn" @click="this.$emit('closeSpeakerModal')">
        <i class="gg-close"></i>
      </div>
      ...
      <div class="content">
        ...
        <div class="desc">
          ...
          <a :href="talkLink" target="_blank" class="talk" v-if="talkLink"
            >Talk</a
          >
        </div>
      </div>
